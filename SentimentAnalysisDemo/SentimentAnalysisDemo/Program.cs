...
namespace SentimentAnalysisDemo
{
    class Program
    {
        ...
        static readonly string _modelPath = Path.Combine(Environment.CurrentDirectory, "TrainedModels");
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                UseModelWithSingleItem(mlContext, model, text);
            } while (true);
        }
        ...
        private static void UseModelWithSingleItem(MLContext mlContext, ITransformer model, string text)
        {
            PredictionEngine<SentimentData, SentimentPrediction> predictionFunction = mlContext.Model.CreatePredictionEngine<SentimentData, SentimentPrediction>(model);
